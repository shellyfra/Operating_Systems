...
int main()
{
    ...
    p = last_address;
    printStats();
    PRINT_POINTER(smalloc(99999999););
    p = last_address;
    printStats();
    DEBUG_PRINT(sfree(p););
    printStats();
    ...
    DEBUG_PRINT(sfree(p););
    printStats();
    PRINT_POINTER(smalloc(100000001););
    p = last_address;
    printStats();
    DEBUG_PRINT(sfree(p););
    printStats();
    ...
    DEBUG_PRINT(sfree(p););
    printStats();
    PRINT_POINTER(smalloc(1000000000000););
    p = last_address;
    printStats();
    DEBUG_PRINT(sfree(p););
    printStats();
    ...
    p = last_address;
    printStats();
    PRINT_POINTER(scalloc(1000, 1000););
    p = last_address;
    printStats();
    DEBUG_PRINT(sfree(p););
    printStats();
    DEBUG_PRINT(sfree(p););
    printStats();
    PRINT_POINTER(scalloc(999, 1000););
    p = last_address;
    printStats();
    DEBUG_PRINT(sfree(p););
    printStats();
    DEBUG_PRINT(sfree(p););
    printStats();
    PRINT_POINTER(scalloc(1000, 999););
    p = last_address;
    printStats();
    DEBUG_PRINT(sfree(p););
    printStats();
    DEBUG_PRINT(sfree(p););
    printStats();
    PRINT_POINTER(scalloc(10000, 10000););
    p = last_address;
    printStats();
    DEBUG_PRINT(sfree(p););
    printStats();
    DEBUG_PRINT(sfree(p););
    printStats();
    PRINT_POINTER(scalloc(10000000, 100000000););
    p = last_address;
    printStats();
    DEBUG_PRINT(sfree(p););
    printStats();
    ...
    c = last_address;
    printStats();
    PRINT_POINTER(srealloc(p, 1000 * 1000););
    c = last_address;
    printStats();
    DEBUG_PRINT(sfree(c););
    printStats();
